...
namespace mtm{
    namespace escaperoom{
        ...
        public:
            ...
            // @param numOfScaryEnigmas: the number of ScaryEnigmas at this room.
            ...
            //@throws EscapeRoomMemoryProblemException in case of creation failure.
            ScaryRoom(const ScaryRoom& room);
            ...
            // the method increase by one the number of scaryEnigmas
            //
            void incNumberOfScaryEnigmas();
            
            //Function returns the age limit allowed in the Scary room.
            //
